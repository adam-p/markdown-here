...
* [Fixed bug](https://github.com/adam-p/markdown-here/issues/109): On Chrome, for some users, the Markdown Here upgrade notification would show up every time they opened Chrome. (I couldn't reproduce it myself, but the notification display is less aggressive now.)
...
* [Fixed bug](https://github.com/adam-p/markdown-here/issues/108): On Chrome, memory was leaking. The size of the leak was proportional to the number of tabs and how long they were left open.
